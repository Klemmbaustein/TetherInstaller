...
public:
	...
	e_3->SetLeftPadding((float)float(0.1));
	...
	e_9->SetColor(Vector3f(float(1)));
	e_9->SetMinSize(Vector2f(float(2)));
	e_9->SetSizeMode(KlemmUI::UIBox::SizeMode::PixelRelative);
	e_9->SetPadding((float)float(5));
